...
dat_prepped_3$subgroup_var <- factor(dat_prepped_3$subgroup_var, levels = c("Gesamt", "Mädchen", "Jungen", "mehr als 100 Bücher", "maximal 100 Bücher", "ohne Zuwanderungshintergrund", "Zuwanderungshintergrund"), ordered = TRUE)
...
```{r eval=FALSE}
save_plot(p_stacked_combined, "C:/Users/hafiznij/Downloads/stacked.pdf",  height = 150, width = 160)
```
