...
gender_prepped$state_var <- process_bundesland(gender_prepped$state_var)
```
...
gender_lesen$state_var <- process_bundesland(gender_lesen$state_var)
...
Currently use the `gender_trend` data because thats better. 
...
column_widths_stand <- standardize_column_width(
  ...
  plot_ranges = c(40, 50, 30) # Range of the x-axes of both plots set in 'axis_x_lims'.
)
```
...
```{r}
save_plot(tableplot_8.4, filename = "C:/Users/hafiznij/Downloads/abb_8.4.pdf", width = 320, height = 226.2 / 2)
```


```{r}
#| eval: false
save_plot(tableplot_8.4, filename = "/home/nick/Downloads/abb_8.4_greek_cmyk.pdf", width = 320, height = 226.2 / 2, encoding = "Greek.enc")

save_plot(tableplot_8.4, filename = "/home/nick/Downloads/abb_8.4_greek_cmyk.pdf", width = 320, height = 226.2 / 2)
