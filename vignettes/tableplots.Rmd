...
```{r}
#| eval: false
save_plot(tableplot_6.5, filename = "C:/Users/hafiznij/Downloads/abb6.5.pdf", height = 140, width = 297, scaling = 0.8)
```
...
save_plot(tableplot_6.6, filename = "C:/Users/hafiznij/Downloads/abb_6.6.pdf", height = 210,  width = 297, scaling = 0.8)
```
