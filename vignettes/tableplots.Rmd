...
trend_3_sub$plain <- trend_3_sub$plain[trend_3_sub$plain$comparison %in% c("crossDiff", "none"), ]

dat_prepped <- prep_tablebarplot(trend_3_sub, 
                                 par = c("mean", "sd"), 
                                 facet_var = "TR_BUNDESLAND", 
                                 total_group = "total")
## Ungünstig, dass das Bundesland mit BL - total benannt ist. 
## Ich glaube teilweise wird ja der Vergleich mit Gesamtdeutschland benötigt. Dafür sollte jedes Bundesland eine eigene Zeile haben. eventuell die Gruppenspalte dafür benutzen?  
