...
tableplot_6.5 <- plot_tablebarplot(
  ...
  columns_table_sig_superscript = list(NULL, "sig_mean_comp_crossDiff_of_groupDiff_totalFacet_weiblichSubgroup_2022_lesen", 
  ...
  plot_settings = plotsettings_tablebarplot(
    ...
    font_size = 2.5, 
    headers_alignment = c(0, rep(2, 6), 0.5),
    headers_nudge_x = rep(0, 8),
    headers_font_size = 2.5, 
    columns_width = c(0.17, rep(0.075, 6), 0.38),
    default_list = abb_6.5
  )
) +
  canvas(160, 100,  units = "mm")
...
```{r}
#| eval: false
save_plot(tableplot_6.5, filename = "C:/Users/hafiznij/Downloads/abb6.5.pdf", width = 160, height = 100, scaling =1)
```
