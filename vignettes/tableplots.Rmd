...
```{r}
#| eval: false
save_plot(tableplot_6.5, filename = "C:/Users/hafiznij/Downloads/abb6.5.pdf", height = 226.2 * 2 / 3)
```
...
save_plot(tableplot_6.6, filename = "C:/Users/hafiznij/Downloads/abb_6.6_greek.pdf", width = 320)
