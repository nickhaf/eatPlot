...
```{r}
mw_prepped <- prep_tablebarplot(trend_mw, subgroup_var = "geschlecht", 
...
tableplot_6.5 <- plot_tablebarplot(
  ...
  columns_table_sig_superscript = list(NULL, "sig_2022_crossDiff_of_groupDiff_mean_lesen", NULL, "sig_2022_crossDiff_of_groupDiff_mean_lesen", "sig_2022_crossDiff_of_groupDiff_mean_hören", NULL, "est_2022_crossDiff_of_groupDiff_mean_hören"), 
