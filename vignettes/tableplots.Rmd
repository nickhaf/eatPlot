...
```{r}
mw_prepped <- mw_prepped[order(mw_prepped$state_var), ]
mw_prepped$y_axis <- 1:nrow(mw_prepped)

## Rename "total" to "Deutschland"
mw_prepped$state_var <- gsub("total", "Deutschland", mw_prepped$state_var)
mw_prepped$state_var <- gsub("ue", "ü", mw_prepped$state_var)
```
...
tableplot_6.5 <- plot_tablebarplot(
  ...
  bar_est = "est_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen",
  bar_fill = "domain",
  bar_sig = "sig_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen",
  columns_table = list(
    "state_var", "est_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen", "se_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen", "es_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen", "est_comparison_groupDiff_sameFacet_mSubgroup_2022_hören", "se_comparison_groupDiff_sameFacet_mSubgroup_2022_hören", "es_comparison_groupDiff_sameFacet_mSubgroup_2022_hören"
  ),
  columns_table_sig_bold = list(NULL, "sig_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen", NULL, "sig_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen", "sig_comparison_groupDiff_sameFacet_mSubgroup_2022_hören", NULL, "sig_comparison_groupDiff_sameFacet_mSubgroup_2022_hören"),
  ...
  columns_table_se = list(NULL, NULL, "se_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen", NULL, NULL, "se_comparison_groupDiff_sameFacet_mSubgroup_2022_lesen", NULL),
  ...
  plot_settings = plotsettings_tablebarplot(
    ...
    bar_nudge_y = rep(c(-0.1, 0.1), nrow(mw_prepped_final) / 2),
