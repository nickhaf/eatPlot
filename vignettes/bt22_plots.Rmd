...
dat_bar[dat_bar$state_var == "wholeGroup", "sig_noTrend_noComp_2021"] <- FALSE
...
```{r chpt_3_MinStand_trend}
  ...
  dat_bar$depVar_fac <- factor(dat_bar$depVar, levels = c("Mindeststandard nicht erreicht",
                                                          "Regelstandard erreicht", 
                                                          "Optimalstandard erreicht"))
  ...
  p_bar_1 <- plot_tablebar(
    ...
    plot_settings = plotsettings_tablebarplot(
      ...
      columns_width = c(0.15, 0.325, 0.075, 0.075, 0.075, 0.075, 0.225),
      columns_nudge_x = c(0, 0, -2, -2, -2, -2),
  ...
  p_bar_2 <- plot_tablebar(
    ...
    plot_settings = plotsettings_tablebarplot(
      ...
      columns_width = c(0.122, 0.122, 0.122, 0.122, 0.512),
