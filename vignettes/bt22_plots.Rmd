...
### Kompetencewerte Bundesländer with y-axis
```{r chpt4_line y-axis}
## Prepare the data with 'KBuecher_imp3' as grouping_var
plot_dat <- prep_plot(
  dat = trend_books,
...
p_bar_1 <- plot_tablebar(
  ...
  plot_settings = plotsettings_tablebarplot(
    ...
    bar_pattern_spacing = 0.0075, #0.0150, # calculated with standardize_pattern_spacing() down below
...
p_bar_2 <- plot_tablebar(
  ...
  plot_settings = plotsettings_tablebarplot(
    ...
    bar_pattern_spacing = 0.0150, #0.0301, # calculated with standardize_pattern_spacing() down below
    default_list = barplot_table_plot_pattern
  )
)

bar_pattern_spacing_stand <- standardize_pattern_spacing(list(p_bar_1, p_bar_2), pattern_spacing = 0.005)
