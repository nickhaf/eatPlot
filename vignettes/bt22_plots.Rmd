...
### Kompetenzwerte Bundesländer with crossDiff_of_groupDiff
```{r chpt4_line_crossDiff_of}
## Prepare the data with 'KBuecher_imp3' as grouping_var
plot_dat <- prep_plot(
  dat = trend_books,
  comparisons = c("crossDiff", "crossDiff_of_groupDiff"), # filter the needed comparisons to reduce ouput
  competence = "GL",
  grouping_vars = "KBuecher_imp3",
  grouping_vars_groups = c("0", "1", "0.vs.1") # crossDiff_of_groupDiff is included in the 0.vs.1 grouping_var 
)
...
p_crossDiff_of_groupDiff <- plot_lineplot(
  plot_dat = plot_dat,
  label_sig_high = "sig_Trend_Comp_crossDiffofgroupDiff_BL-groupingvar_vs_1_VS_wholeGroup-groupingvar_vs_1", 
  title_superscripts = list(
    "Land-17" = "a",
    "Land-45" = "3"
  ),
...
p_crossDiff_of_groupDiff
```

```{r, eval = FALSE}
save_plot(p_crossDiff_of_groupDiff, filename = "../p_crossDiff_of_groupDiff.pdf")
```
