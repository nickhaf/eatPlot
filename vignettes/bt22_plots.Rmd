...
mean_noTrend <- plot_tablebar(dat_bar_mean_sd,
              ...
              bar_header = "**Abweichung vom Mittelwert <br> für Deutschland**", 
              ...
              columns_headers = list("**Land**", "***M***", "***(SE)***", "***SD***", "***(SE)***"), 
              columns_table_se = list(NULL, NULL, "se_noTrend_noComp_2021_mean", NULL, "se_noTrend_noComp_2021_sd" ),
              y_axis = "state_var",
              plot_settings = plotsettings_tablebarplot(background_stripes_colour = c(rep(c("white", "gray94"), 8), "gray87"),
...
```{r, eval = FALSE}
save_plot(mean_noTrend, filename = "../Kap4_2022_noTrend.pdf", height = 226.2 / 3)
```
