...
column_widths <- list(p1 =  c(0.09, 0.25, 0.04, 0.04, 0.04, 0.04, NA), ## Anteilig berechnen
                      p2 = c(0.04, 0.04, 0.04, 0.04, NA)
                      )
column_widths <- calc_column_width(column_widths = column_widths, plot_ranges = c(60, 40), columns_table_sig_high_letter_nudge_x = 10)
...
p_bar_1 <- plot_tablebar(
  ...
  plot_settings = plotsettings_tablebarplot(
    ...
    columns_width = column_widths[[1]],
    columns_table_sig_high_letter_nudge_x = column_widths[[3]][1], 
