...
p_bar_1 <- plot_tablebar(
  ...
  plot_settings = plotsettings_tablebarplot(
    ...
    bar_pattern_spacing = 0.0133, # calculated with standardize_pattern_spacing() down below
...
p_bar_2 <- plot_tablebar(
  ...
  plot_settings = plotsettings_tablebarplot(
    ...
    bar_pattern_spacing = 0.0267, # calculated with standardize_pattern_spacing() down below
    default_list = barplot_table_plot_pattern
  )
)

bar_pattern_spacing_stand <- standardize_pattern_spacing(list(p_bar_1, p_bar_2), pattern_spacing = 0.02)
