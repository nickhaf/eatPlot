...
-	Hochgestelltes `a`:
    * Bei bundesweiten Trends für Gruppen: Statistisch signifikante Abweichung (*p* < .05) zum Trend in der Gesamtpopulation aller Neuntklässler:innen derselben Gruppe in Deutschland
...
-	Ausgefülltes Dreieck für Werte, die statistisch signifikant (*p* < .05) vom Wert derselben Gruppe in der Gesamtpopulation abweichen.
-	Ausgefüllter Kreis für Werte, die statistisch nicht signifikant vom Wert derselben Gruppe in der Gesamtpopulation abweichen.
