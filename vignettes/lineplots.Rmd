...
lineplot_germany <- plot_lineplot(
 ...
 point_sig = NULL,
  ...
  ggview:: canvas(118, 185, units = "mm")
```
...
lineplot_germany <- plot_lineplot(
 ...
 point_sig = NULL,
  ...
  ggview:: canvas(160, 185*2/3, units = "mm")
```

```{r}
#| eval: false
save_plot(lineplot_germany, filename = "C:/Users/hafiznij/Downloads/lineplot_2_groups_germany2x3.pdf", height = 185, width = 118, scaling = 1)
```
