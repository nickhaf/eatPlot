...
```{r fig.width = 160, fig.height = 185}
#| echo: false
lineplot_1
```
...
```{r  fig.width = 108, fig.height = 185}
lineplot_germany
```
...
```{r  fig.width = 160, fig.height = 123.3333}
lineplot_germany_2
```
...
```{r}
#| eval: false
save_plot(lineplot_na, filename = "C:/Users/hafiznij/Downloads/lineplot_na.pdf", width = 160, height = 185, scaling = 1)
```
...
```{r}
#| eval: false
save_plot(lineplot_2_long, filename = "C:/Users/hafiznij/Downloads/lineplot_2_groups_long.pdf", width = 160, height = 185, scaling = 1)
```
