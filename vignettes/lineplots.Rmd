...
dat_lineplot_2$subgroup_var <- factor(dat_lineplot_2$subgroup_var, levels = c("weiblich", "maennich", "total"), ordered = TRUE)
...
lineplot_2 <- plot_lineplot(
  ...
  plot_settings = plotsettings_lineplot(subgroup_colours = c(weiblich = "#000000", maennlich = "#999999"), ## Here we determine the colours of the subgroups
