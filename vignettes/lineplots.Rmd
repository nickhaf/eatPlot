...
#| eval: false
save_plot(lineplot_1, filename = "C:/Users/hafiznij/Downloads/lineplot_1_group.pdf", scaling = 0.7)
```
...
```{r}
#| eval: false
save_plot(lineplot_2, filename = "C:/Users/hafiznij/Downloads/lineplot_2_groups.pdf", scaling = 0.7)
```
...
```{r}
#| eval: false
save_plot(lineplot_germany, filename = "C:/Users/hafiznij/Downloads/lineplot_2_groups_germany.pdf", height = 297/4, scaling = 0.7)
```
