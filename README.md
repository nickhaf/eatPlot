...
<!-- or: -->
<!-- ```{r} -->
<!-- lineplot_dat <- prep_plot(dat = trend_books,  -->
...
<!-- ```{r} -->
<!-- lineplot_dat <- filter_rows(lineplot_dat, state = "wholeGroup", remove = TRUE) -->
<!-- ``` -->
<!-- ### Plotting -->
...
<!-- ```{r} -->
<!-- p_table <- plot_table(barplot_dat[["plot_table"]]) -->
<!-- p_bar <- plot_bar(barplot_dat) -->
<!-- plot_table_bar(p_table, p_bar) -->
<!-- ``` -->
<!-- Or, if you want a lineplot: -->
<!-- ```{r} -->
<!-- p_line <- plot_lineplot(lineplot_dat, axis_x_label_centralize = 0.15) -->
<!-- p_line -->
<!-- ``` -->
