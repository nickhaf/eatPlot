...
#' @param label_sig_high_extra_column Logical indicating whether the superscript for significances should be added directly into the label (necessary for lineplots), or should be written into an extra column with the ending '_sig_superscript' (necessary for tables). #which is which?
...
#'
#'          # are parameters missing? (see most 'label' parameters in the function below)
#'
