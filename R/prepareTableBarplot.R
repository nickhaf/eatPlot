...
#' Prepare data for plotting a TableBarplot
#'
...
#'
#' @return Returns a \code{data.frame} which can be used as input for \code{plotTableBar}.
#' @export
#'
#' @examples tbd
prepareTableBarplot <- function(data, subGroups, sigNiveau){
