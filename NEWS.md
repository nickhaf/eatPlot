...
* Implement new [plotsettings_tablebarplot()] argument: `bar_label_nudge_out` defines a value below which labels are nudged to the left or right of a stacked bar. Useful for small bars, where labels don't fit. 
