...
p1 <- plot_points(dat_long, grouping_var = "group_comparisons")

p2 <- p1 +
  connect_points(bt21_Trend_sig, "2011", "2016", grouping_var = "group_comparisons") +
  connect_points(bt21_Trend_sig, "2016", "2021", grouping_var = "group_comparisons") +
  linetype_iqb +
    labs(title = i) +
    theme(
