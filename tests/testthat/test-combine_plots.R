...
test_that("Example barplot long format is plotted correctly", {
  ...
  dat_barse_Trend_noComp_20112016_percent_label <- construct_label(dat_bar,
    column_se = "se_Trend_noComp_20112016_percent",
    round_se = 1
  )

  dat_bar$se_Trend_noComp_20162021_percent_label <- construct_label(dat_bar,
    column_se = "se_Trend_noComp_20162021_percent",
    round_se = 1
  )
