...
# # # # # # Tabelle -----------------------------------------------------------------
# # #
# # # y_axis_plot <- plot_column(vec = unique(data_bar_l$state_var), plot_settings = plotsettings_barplot(default_list = barplot_MinSta)) +
# # #   theme_table_col()
# # #
...
#                plot_settings = plotsettings_barplot(bar_pattern_fill_colour = stand_pattern_fill,
